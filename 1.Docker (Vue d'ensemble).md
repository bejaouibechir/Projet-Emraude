...
```bash
dotnet new webapi --use-controllers -o C:\temp\Api
```
...
services:
  ...
  web:
    ...
    environment:
      ...
      - ConnectionStrings__DefaultConnection=Host=localhost;Database=mydatabase;Username=myuser;Password=mypassword
    ports:
      - "8080:80"
    depends_on:
      - db
